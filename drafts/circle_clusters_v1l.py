...
# -*- coding: utf-8 -*-
"""
circle_clusters_v1l.py — edge-wise distributed labels (outside), labels show total turns per cluster.
- Labels now: "cluster_id, total_turns" (rounded to nearest int), not number of segments.
- Everything else identical to v1k (CSV paths, markers as black X, etc.).
"""
...
# --- main ---
def main():
    ap = argparse.ArgumentParser(description="Circles → clusters with edge-wise outside labels (show total turns)")
