...
# -*- coding: utf-8 -*-
"""
circle_clusters_v1o.py - edge-wise outside labels; CSVs -> /outputs; debug -> /debugs.
- Prints console summary table: cluster_id, n_segments, turns, duration_min
- Plot labels show: "cluster_id, turns, minutes" (minutes as float, 1 decimal)
- Track plotted as closed polygon; labels placed outside along nearest edge, spaced to avoid clutter
"""
...
def main():
    ...
    if not clusters.empty:
        ...
        view = view[["cluster_id", "n_segments", "n_turns_sum", "duration_min"]].rename(
