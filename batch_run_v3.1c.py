    ...
    while i < n:
        ...
        if rot >= 360.0:
            ...
            for k in range(i0+1, i1+1):
                ...
                v_inst = seg_m / dt
                # instantaneous bank (rad) via centripetal relation
            ...
            if banks_deg:
                ...
                bank_masd_deg_w  = float(np.nanmean(np.abs(np.diff(b_arr)))) if len(b_arr) >= 2 else 0.0
            else:
            ...
            circles.append({
                ...
                # NEW variability metrics (require the block you inserted earlier)
