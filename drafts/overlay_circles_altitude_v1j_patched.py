...
TURN_MIN_DEG_S     = 4.0   # keep circles with turn_rate >= 6 deg/s
TURN_MAX_DEG_S     = 20.0  # and <= 18 deg/s
RADIUS_MIN_M       = 30.0  # keep circles with radius >= 50 m
RADIUS_MAX_M       = 600.0 # and <= 400 m
