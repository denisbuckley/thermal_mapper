...
Usage:
  python batch_match_igc_v3e.py --igc-dir ./igc --alt-script altitude_gain_v3g.py --circ-script circles_clean_v2c.py --outputs-dir outputs
"""
...
def main():
    ...
    ap.add_argument("--igc-dir", default=None)
